...
class TaskMetrics extends Serializable {
  ...
  //Peilong
  var taskStart: Long = _
  var taskEnd: Long = _
  var deserializationStart: Long = _
  var deserializationEnd: Long = _
  var executionStart: Long = _
  var executionEnd: Long = _
  var serializationStart: Long = _
  var serializationEnd: Long = _
  var jvmGCStart: Long = _
  var jvmGCEnd: Long = _
